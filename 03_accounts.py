...
''' uncomment to test masking for a static 10-digit account number 
# Part 1 
...
# get account number length 
n_of_digits = len(account_number) 

# calculate how many Xs need to be added to mask the account number 
n_of_x = n_of_digits - 4 

# concatenate the number of X needed + a slice of the account number, so that only the last 4 digits are displayed 
